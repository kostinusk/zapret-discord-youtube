...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,13000,13005,13200,14000,14001,14008,14020-14024,%GameFilterTCP% --wf-udp=443,19294-19344,50000-50100,3074,6015,10000-10099,%GameFilterUDP% ^
...
--filter-udp=6015,10000-10099 --dpi-desync=fake --dpi-desync-repeats=12 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_dbankcloud_ru.bin" --dpi-desync-cutoff=n2 --new ^
...
--filter-tcp=13000,13005,13200,14000,14001,14008,14020-14024 --dpi-desync=multisplit --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n3 --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_4pda_to.bin" --new ^
